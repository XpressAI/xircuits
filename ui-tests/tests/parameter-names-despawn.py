...
with sync_playwright() as p:
    ...
    verify_new_port_spawned(page, "GradioInterface", "parameter-dynalist-parameterNames-1")

    delete_component_directly(page, "Literal String")

    verify_port_not_spawned(page,"GradioInterface", "parameter-dynalist-parameterNames-1")