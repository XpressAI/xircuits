...
export const RunDialog = ({
    ...
    return (
        <form>
            <h3 style={{ marginTop: 0, marginBottom: 0 }}>Hyperparameter:</h3>
			<div><h4 style={{marginTop: 0, marginBottom: 0}}>String</h4></div>
            ...
            <div>
                {
                    ...
                    <><br/><h4 style={{ marginTop: 0, marginBottom: 0 }}>Boolean</h4></> : null
                }
			</div>
            ...
            <div>
                {
                    ...
                    <><br /><h4 style={{ marginTop: 0, marginBottom: 0 }}>Integer</h4></> : null
                }
            </div>
            ...
            <div>
                {
                    ...
                    <><br /><h4 style={{ marginTop: 0, marginBottom: 0 }}>Float</h4></> : null
                }
            </div>
