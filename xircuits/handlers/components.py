...
DEFAULT_COMPONENTS = {
    ...
    5: { "name": "Literal Multi-String", "returnType": "string"},
    6: { "name": "Literal String", "returnType": "string"},
    7:{ "name": "Literal Integer", "returnType": "int"},
    8:{ "name": "Literal Float", "returnType": "float"},
    9:{ "name": "Literal True", "returnType": "boolean"},
    10:{ "name": "Literal False", "returnType": "boolean"},
    11:{ "name": "Literal List", "returnType": "list"},
    12:{ "name": "Literal Tuple", "returnType": "tuple"},
    13:{ "name": "Literal Dict", "returnType": "dict"},
