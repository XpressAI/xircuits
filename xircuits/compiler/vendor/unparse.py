# This file has been copied from the Python 3.8.16 source distribution.
# It is used to support Python 3.8.
# See the LICENSE file in this directory for the full license.
